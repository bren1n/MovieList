...
public class MovieFavoriteAdapter extends RecyclerView.Adapter<MovieFavoriteAdapter.MyViewHolder> {
    ...
    public MovieFavoriteAdapter(Context context, List<Movie> movieList, RecyclerViewInterface recyclerViewInterface) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_list_favorites, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            name = itemView.findViewById(R.id.listNameFavorites);
            releaseDate = itemView.findViewById(R.id.listReleaseDateFavorites);
            imageUrl = itemView.findViewById(R.id.listImageUrlFavorites);
            rate = itemView.findViewById(R.id.listRateFavorites);
